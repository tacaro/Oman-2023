...
GC_file_directory = "data/gc_data/2023-09-29/" # If your GC data is not in a file like this, change this string!
...
appended_data.to_csv("data/gc_data/tabulated/GCData0929.csv")
