...
This is a script for processing of Cline sulfide assay data from the "control" unamended samples.
...
```{r}
custom_order <- c("Acetate", "Bicarbonate", "Formate", "None")
...
cline_data_corrected |> 
  ...
  scale_y_continuous(expand = c(0, 0), limits = c(0, 500), breaks = c(0, 100, 200, 300, 400)) +
  theme_om23() +
  labs(
    fill = "",
    x = "",
