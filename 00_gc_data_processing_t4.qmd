---
title: "00_gc_data_processing_t3"
author: "Tristan Caro"
format: html
editor: visual
editor_options: 
...
GC_file_directory = "data/gc_data/2023-09-29/" 
...
appended_data.to_csv("data/GC_Data_Table4.csv")
...
```{r}
# Load GC raw data
gc <- read_csv("data/GC_Data_Table4.csv") |> 
...
volume_to_moles <- function(pressure_atm = 0.8, vol_mL, R = 0.082057338	, temp_C = 20) {
  ...
  moles = (pressure_atm * vol_L) / (R * temp_K)
  return(moles)
}
...
but first we convert from peak area to $n$ moles of gas injected:
...
```{r}
saveRDS(object = gc_samples_processed, file = "cache/gc_samples2.RDS")
```
