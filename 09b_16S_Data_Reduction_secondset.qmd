...
> Note: this 16S data reduction script is for the second set of 16S sequencing done on BA3A samples.
...
data.fp <- "data/16S_batch2/03.22.2024_Shared_16S_Run"
list.files(data.fp)
...
barcode.fp <- "data/16S_batch2/03.22.2024_Shared_16S_Run/TristanCaro_March2024_16S_BarcodeFile.txt"
map.fp <- NA
...
```{r}
project.fp <- "/data/16S_batch2/outputs" # CHANGE ME to project directory; don't append with a "/"

# Set up names of sub directories to stay organized
preprocess.fp <- "data/16S_batch2/outputs/01_preprocess"
demultiplex.fp <- "data/16S_batch2/outputs/01_preprocess/demultiplexed"
filtN.fp <- "data/16S_batch2/outputs/01_preprocess/filtN"
trimmed.fp <- "data/16S_batch2/outputs/01_preprocess/trimmed"
filter.fp <- "data/16S_batch2/outputs/02_filter"
table.fp <- "data/16S_batch2/outputs/03_tabletax"
```
